...
```sh
wget -c https://github.com/appleboy/CodeGPT/releases/download/v0.0.6/CodeGPT-0.0.6-linux-amd64 -O codegpt
```

On macOS (Intel amd64)

```sh
wget -c https://github.com/appleboy/CodeGPT/releases/download/v0.0.6/CodeGPT-0.0.6-darwin-amd64 -O codegpt
```

On macOS (Apple arm64)

```sh
wget -c https://github.com/appleboy/CodeGPT/releases/download/v0.0.6/CodeGPT-0.0.6-darwin-arm64 -O codegpt
```

On Windows (AMD64)

```sh
wget -c https://github.com/appleboy/CodeGPT/releases/download/v0.0.6/CodeGPT-0.0.6-windows-amd64.exe -O codegpt.exe
```
